---
specdojo:
  id: prj-0001:grade-kata-67d6288cdc9f-plan
  type: exec-plan
  rulebook: none
  task_id: GRADE-KATA-67D6288CDC9F
  name: "grade: docs/ja/specdojo/recipes/cdfd-recipe.md"
  mode: review
  status: ready
  project_id: prj-0001
  targets:
...
# Review Plan: GRADE-KATA-67D6288CDC9F grade: docs/ja/specdojo/recipes/cdfd-recipe.md
...
評価対象 `docs/ja/specdojo/recipes/cdfd-recipe.md` を共通 viewpoint と category rubric で 0-4 判定する。deterministic viewpoint は CLI が判定するため、agent の出力には含めない。

## 2. 対象項目

- `target`: kata
- `rubric`: grade-rubric-v1
- `document_id`: specdojo:cdfd-recipe
- `評価対象`: `docs/ja/specdojo/recipes/cdfd-recipe.md`
...
- `docs/ja/specdojo/samples/cdfd-sample.md`
- `docs/ja/specdojo/templates/cdfd-template.md`
