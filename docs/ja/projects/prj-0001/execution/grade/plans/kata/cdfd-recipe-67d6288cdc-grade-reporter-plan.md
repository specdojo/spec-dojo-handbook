---
specdojo:
  id: prj-0001:grade-kata-67d6288cdc9f-reporter-plan
  type: exec-plan
  rulebook: none
  task_id: GRADE-KATA-67D6288CDC9F-REPORTER
  name: "grade reporter: docs/ja/specdojo/recipes/cdfd-recipe.md"
  mode: review
  status: ready
  project_id: prj-0001
  targets:
...
# Reporter Plan: GRADE-KATA-67D6288CDC9F-REPORTER grade: docs/ja/specdojo/recipes/cdfd-recipe.md
...
```json
{
  ...
  "documents": [
    {
      "path": "docs/ja/specdojo/recipes/cdfd-recipe.md",
      "viewpoints": [
        {
