...
specdojo:
  ...
  grade:
    ...
    verdict: needs-work
    score: 91
    graded_at: "2026-09-01T22:02:07.209Z"
    graded_by: gemma-expert-executor
    content_hash: 1298b1a689ad423f625ea43ecb296c2301be065600266602b71767b5b795624f
    categories:
...
<!-- specdojo:finding id=F001 severity=major rule=vp-qe-kata-conformance 指定されているサンプル `specdojo:atc-index-sample` が、本ルールブックの第5章で定義した標準テンプレ（見出し構成および順序）に準拠していない。 -->
