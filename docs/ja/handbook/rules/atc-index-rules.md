...
生成する `atc-overview` 本文の見出しは **## 6. 観点/条件の採用基準と対象別への分配方針（共通）**
...
生成する `atc-overview` 本文の見出しは **## 7. 受入テストの環境/データ/外部依存の扱い（共通）**
...
生成する `atc-overview` 本文の見出しは **## 8. ケース表の共通カラム**
...
生成する `atc-overview` 本文の見出しは **## 9. メモ / 将来課題**
